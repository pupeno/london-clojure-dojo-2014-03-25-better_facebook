...
Two middleware functions by default which are are located in the `better_facebook.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `better_facebook.handler` namespace to manage the enabled middleware.
